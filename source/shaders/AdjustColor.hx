...
/*
  A shader that adjusts the hue, saturation, brightness, and contrast of a sprite the way Adobe Animate/Flash does.
 */
class AdjustColor extends FlxShader
{
  /*
    The hue component of the shader.
   */
  public var baseHue(default, set):Float;

  /*
    The saturation component of the shader.
   */
  public var baseSaturation(default, set):Float;

  /*
    The brightness component of the shader.
   */
  public var baseBrightness(default, set):Float;

  /*
    The contrast component of the shader.
   */
