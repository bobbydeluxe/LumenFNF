...
class CreditsState extends ScriptedState
{
	...
	public var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
		...
		['PhoenixPunk',			'phoenix', 			'added some little tweaks',						'https://gamebanana.com/members/3957045',				'E3345D'],
		[''],
		["Lumen Contributors"],
		...
		['SunkyDev31',			'sunky',			'Translated the Week 6 (Pico Mix) dialogues for Português (Brasil)', 'https://bsky.app/profile/sunkydunky31.bsky.social', 'FF3B25'],
