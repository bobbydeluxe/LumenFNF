...
class CreditsState extends ScriptedState
{
	...
	public var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
		...
		['DuskieWhy',		'duskie',		'owner and programmer of nightmarevision, the source engine the epic rating implementation was based on',		'https://twitter.com/DuskieWhy',		'6D32A8'],
