...
/*
 * This is the Psych Engine freeplay state.
 * If you are looking for the P-Slice freeplay state, it is in mikolka/vslice/freeplay/FreeplayState.hx
 */

class PsychFreeplayState extends ScriptedState
{
	...
	{
		lerpSelected = FlxMath.lerp(curSelected, lerpSelected, Math.pow(Math.PI, -elapsed * 9.6));
