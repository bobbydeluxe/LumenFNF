...
// customflxcolor class provided by TheLeerName, thanks bro - bobbyDX

class CustomFlxColor
{
    // colors
    public static var BLACK(default, null):Int = 0xFF000000;
    public static var GRAY(default, null):Int = 0xFF808080;
    public static var WHITE(default, null):Int = 0xFFFFFFFF;
    public static var TRANSPARENT(default, null):Int = 0x00000000;

	public static var GREEN(default, null):Int = 0xFF008000;
	public static var LIME(default, null):Int = 0xFF00FF00;
	public static var YELLOW(default, null):Int = 0xFFFFFF00;
	public static var ORANGE(default, null):Int = 0xFFFFA500;
	public static var RED(default, null):Int = 0xFFFF0000;
	public static var PURPLE(default, null):Int = 0xFF800080;
	public static var BLUE(default, null):Int = 0xFF0000FF;
	public static var BROWN(default, null):Int = 0xFF8B4513;
	public static var PINK(default, null):Int = 0xFFFFC0CB;
	public static var MAGENTA(default, null):Int = 0xFFFF00FF;
	public static var CYAN(default, null):Int = 0xFF00FFFF;
